# IntentTwin — Empirical Product Drift Experiment (EXP-001)

> **Notice:** This document defines the formal research design, mathematical evaluation metrics, and observed empirical findings for benchmark **EXP-001**. It is provided for scientific reproducibility and evaluation purposes; reading this specification is **not** required for standard everyday use of IntentTwin.
...
### Target Application: "DocuPay SaaS" (`benchmarks/fixture`)
